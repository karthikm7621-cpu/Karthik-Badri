...
```
cd existing_repo
git remote add origin https://code.swecha.org/Badrinath/team-atk.git
git branch -M main
...
* [Set up project integrations](https://code.swecha.org/Badrinath/team-atk/-/settings/integrations)
